...
const PolicyTerms = () => {
  return (
    <div style={{textAlign: 'center'}}>
      ...
      <p>
        Welcome to <b>santtech</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>srmspot.com</b> (together or individually
        “Service”) operated by <b>santtech</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>support@srmspot.com</b> so we can try to find a solution. These Terms
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at support@srmspot.com.
      </p>
      ...
      <p>
        santtech has the right but not the obligation to monitor and edit all
        Content provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property
        of santtech or used with permission. You may not distribute, modify,
      ...
      <p>
        ...
        santtech and its licensors. Service is protected by copyright,
      ...
      <p>
        ...
        to support@srmspot.com, with the subject line: “Copyright Infringement”
      ...
      <p>
        You can contact our Copyright Agent via email at support@srmspot.com.
      </p>
      <p>
        12. <b>Error Reporting and Feedback</b>
      </p>
      <p>
        You may provide us either directly at support@srmspot.com or via third
      ...
      <p>
        ...
        are not owned or controlled by santtech.
      </p>
      <p>
        santtech has no control over, and assumes no responsibility for the
      ...
      <p style={{marginTop: '5em', fontSize: '0.7em'}}>
        ...
        were created for <b>srmspot.com</b> by{" "}
        legal Representatives lead by Ruth on 2024-02-24.
      </p>
    </div>
  );
};
